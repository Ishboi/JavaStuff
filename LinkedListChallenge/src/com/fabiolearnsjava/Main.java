...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Hamburger hamburger = new Hamburger("Basic", "Sausage", 9.56, "Whiite");
        double price = hamburger.getBasePrice();
        hamburger.addToppings(1, 1, 1 , 0);
        System.out.println("Total Burguer price is " + hamburger.getCost());
